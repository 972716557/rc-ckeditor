...
import requesting, { RESPONSE_CODE_MAP } from '@/utils/request';
import type { ResponseData } from 'types';

import api from './api';

export async function judgeTradeTime(payload: {}): Promise<ResponseData<boolean>> {
...
export async function getUploadVideoSign(): Promise<ResponseData<{ videoSign: string }>> {
  const options: AxiosRequestConfig = {
